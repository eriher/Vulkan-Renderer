...
void RenderingPipeline::draw(VkCommandBuffer& cb, std::vector<VkDescriptorSet*> descriptors, int i)
{
...
void RenderingPipeline::createGraphicsPipeline(std::string vertFilePath, std::string fragFilePath)
{

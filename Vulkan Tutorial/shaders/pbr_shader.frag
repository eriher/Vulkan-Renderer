...
vec3 calculateDirectIllumiunation(vec3 wo, vec3 n)
{
	...
	///////////////////////////////////////////////////////////////////////////
	vec3 diffuse_term = m.color.rgb * (1/PI) * direction * li;
	//return(diffuse_term);
	...
	vec3 metal_term = brdf * m.color.rgb * dot(n, wi) * li;
...
vec3 calculateIndirectIllumination(vec3 wo, vec3 n)
{
	...
	vec3 diffuse_term = m.color.rgb * (1.0 / PI) * irradiance;
	//return diffuse_term;
	///////////////////////////////////////////////////////////////////////////
	...
	vec3 metal_term = f * m.color.rgb * li;
	vec3 microfacet_term = m.metalness * metal_term + (1 - m.metalness) * dielectric_term;
	return m.reflectivity * microfacet_term + (1 - m.reflectivity) * diffuse_term;
}

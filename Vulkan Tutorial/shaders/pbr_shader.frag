...
vec3 calculateDirectIllumiunation(vec3 wo, vec3 n)
{
	...
	vec3 wi = normalize(light.position - viewSpacePosition);
	///////////////////////////////////////////////////////////////////////////
	...
	if(direction <= 0)
		return vec3(0.0);
	vec3 li =  light.intensity * light.color * (1/pow(length(light.position - viewSpacePosition),2));
	///////////////////////////////////////////////////////////////////////////
	// Task 1.3 - Calculate the diffuse term and return that as the result
	///////////////////////////////////////////////////////////////////////////
	vec3 diffuse_term = m.color * (1/PI) * abs(direction) * li;
	return(diffuse_term);
...
void main() {
	...
	vec3 direct_illumination_term = vec3(1.0,1.0,0.0);
	//{ // Direct illumination
	//	direct_illumination_term = calculateDirectIllumiunation(wo, n);
	//}

	outColor = vec4(direct_illumination_term,1.0);
